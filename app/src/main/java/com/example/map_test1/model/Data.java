...
/**
 * Created by Yannick Knoll on 03.03.23.
 */
class Data {
    public final static int[] years = new int[]{2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022};
    public final static String[] districts = new String[]{"Kungsholmen", "Östermalm", "Bromma", "Skärholmen", "Södermalm", "Hägersten-Älvsjö", "Norrmalm", "Farsta", "Rinkeby-Kista", "Skarpnäck", "Spånga - Tensta", "Hägersten-Älvsjö (2)", "Enskede - Årsta - Vantör", "Hässelby - Vällingby"};
    //    private final static String[] crimes = new String[]{"Attempted murder or manslaughter (1, 2§)", "Abuse (5, 6 §)", "Causing the death of others (7, 10 §)", "Causing bodily injury, unrelated with a traffic accident (8, 10 §)", "Rape (1 a §)", "Sexual assault (2 §)  (Fr. o. m. 2018-07)", "Theft, roberry, etc. (8 kap.)", "Crimes against the public (13-15 kap.)", "Generally dangerous crimes (13 kap.)", "Violation of the narcotics penal code", "Violation of the law regarding guns (9 kap. 1-2 §)", "Violation of the law for carrying knives (1, 2, 4 §)"}; // [value]
        public final static String[] crimes = new String[]{"Attempted murder or manslaughter", "Abuse", "Causing the death of others", "Causing bodily injury, unrelated with a traffic accident", "Rape", "Sexual assault", "Theft, roberry, etc.", "Crimes against the public", "Generally dangerous crimes", "Violation of the narcotics penal code", "Violation of the law regarding guns", "Violation of the law for carrying knives"}; // [value]
    public final static int[][][] data = new int[][][]{ // [district][year][value]
            {
