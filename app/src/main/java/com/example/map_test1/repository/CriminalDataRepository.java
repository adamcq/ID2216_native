package com.example.map_test1.repository;

import androidx.lifecycle.MutableLiveData;

public class CriminalDataRepository {
    private static CriminalDataRepository instance;
    private Integer[] years;
    private String[] districts;
    private String[] crimes;
    private Integer[][][] records; // [district][year][crime]

    public static CriminalDataRepository getInstance() {
        if (instance == null) {
            instance = new CriminalDataRepository();
        }
        return instance;
    }

    public MutableLiveData<Integer[]> getYears() {
        setYears();
    ...
    public MutableLiveData<String[]> getDistricts() {
        setDistricts();

        MutableLiveData<String[]> data = new MutableLiveData<>();
        data.setValue(districts);
        return data;
    }

    public MutableLiveData<String[]> getCrimes() {
        setCrimes();

        MutableLiveData<String[]> data = new MutableLiveData<>();
        data.setValue(crimes);
        return data;
    }

    public MutableLiveData<Integer[][][]> getRecords() {
        setRecords();
    ...
    /**
     * The contents of the set methods are now hard coded.
     * The hardcoded data can later be replaced with methods to access database
     */
    private void setYears() {
        years = new Integer[]{2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022};
    }
    ...
    private void setCrimes() {
        crimes = new String[]{
                ...
                "Causing bodily injury, unrelated with a traffic accident",
                "Rape",
                "Sexual assault",
                "Theft, roberry, etc.",
                "Crimes against the public",
                "Generally dangerous crimes",
                "Violation of the narcotics penal code",
                "Violation of the law regarding guns",
                "Violation of the law for carrying knives"};
    }

    private void setRecords() {
        records = new Integer[][][]{ // [district][year][value]
                {
